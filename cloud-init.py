...
runcmd:
  ...
  - [chown, "root:root", "/etc/cloud/cloud.cfg.d/10_tinkerbell.cfg"]
  ...
  - [chown, "root:root", "/etc/cloud/ds-identify.cfg"]
  - [chmod, "644", "/etc/cloud/ds-identify.cfg"]
  - [chown, "root:root", "/etc/netplan/config.yaml"]
  - [chmod, "600", "/etc/netplan/config.yaml"]  # Netplan configs typically have stricter permissions
